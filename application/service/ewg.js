...
casper.userAgent('Mozilla/5.0 (X11; Linux x86_64; rv:54.0) Gecko/20100101 Firefox/54.0');
...
casper.waitForSelector("table.search-results-table", function(){
  this.trace('three');
  ...
  throw 'timeout table.search-results-table';
}, 10000);
...
casper.then(function(){
  ...
  var json = JSON.stringify(data, null, 2);
   ...
   casper.thenOpen('https://lcl.qea.la:8109/api/results', {
      method: 'post',
      data:{json:json}
   });
